...
var theResult = $.strRemove("select", b);// patch according to our case

					if(theResult.indexOf(q)==-1){v=0}else{v=1; break}
				}
			}
			if(v){n++}
			this.t.a[i].s=v
